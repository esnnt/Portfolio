...
export default function FaultyTerminal({
    ...
    const handleMouseMove = useCallback(e => {
        // Container yerine direkt window üzerinden hesaplıyoruz
